...
function displaySurvey(numberEaters, numEater, zipcode) {
  ...
  //if all eaters have taken the survey already....lets do some logic to calculate the type of restaurant and the price level to issue response....
    ...
    $.ajax({
      url: "https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyAtCZISv6xfi48x9WbfjCY-yIolj9lo6tkAIzaSyDM07rWKSpGs6eZ788blx8FNXQI9SoxsZE&components=postal_code:" + zipcode + "&sensor=false",
      method: "POST",
